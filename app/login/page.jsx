    ...
    <div className="min-h-screen flex items-center justify-center bg-amber-50 dark:bg-zinc-900 px-4">
      <div className="max-w-md w-full bg-white dark:bg-zinc-800 rounded-lg shadow-lg p-8 border border-amber-200 dark:border-zinc-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 py-2 rounded-lg font-semibold hover:bg-zinc-700 dark:hover:bg-zinc-200 transition-colors"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="mt-4 w-full flex items-center justify-center gap-2 bg-white dark:bg-zinc-700 border border-zinc-300 dark:border-zinc-600 text-zinc-900 dark:text-white py-2 rounded-lg font-semibold hover:bg-zinc-50 dark:hover:bg-zinc-600 transition-colors"
          >
        ...
        <p className="mt-4 text-center text-sm text-zinc-600 dark:text-zinc-400">
          <Link href="/" className="text-zinc-900 dark:text-white hover:underline">
            Back to Home
          </Link>
        </p>
      </div>
